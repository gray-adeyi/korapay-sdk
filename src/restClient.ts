...
export default class RestClient {
  ...
  async call(endpoint: string, method: HTTPMethod, data?: any) {
...
private get headers() {
  ...
  private responsePayloadTransformerInterceptor(response: AxiosResponse) {
    console.log("before treansform", response.data);
...
private loadEncryptionKey(value?: string) {
    ...
    this.encryptionKey = Deno.env.get(RestClient.ENV_ENCRYPTION_KEY_NAME) as string;
  }
}
